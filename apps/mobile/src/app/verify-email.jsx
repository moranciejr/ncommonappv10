...
export default function VerifyEmailScreen() {
  ...
  const refreshAuthMutation = useMutation({
    ...
    onError: (err) => {
      console.error(err);
      // refreshAuthError surfaces in the UI via refreshAuthMutation.error below
    },
  });
  ...
  const errorMessage = useMemo(() => {
    if (resendMutation.isPending || refreshAuthMutation.isPending) {
      return null;
    }

    if (refreshAuthMutation.error) {
      return "Could not refresh your session. Please try again or sign out.";
    }
